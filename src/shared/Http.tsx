...
function isDev() {
  if (location.hostname !== 'localhost' && location.hostname !== '127.0.0.1' && location.hostname !== '192.168.0.104') {
    return false
  }
  return true
}

export const http = new Http(isDev() ? 'api/v1' : 'http://119.13.81.176:3000/api/v1')
